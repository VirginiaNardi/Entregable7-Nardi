...
app.use(session({
  store: MongoStore.create({
    mongoUrl: 'mongodb+srv://virnardi1680:k7cjxfFSFW9zHHZ3@cluster0.i55sczy.mongodb.net/',
    dbName: 'ecommerce',
  }),
  secret: 'secret',
  resave: true,
...
try {
    await mongoose.connect('mongodb+srv://virnardi1680:k7cjxfFSFW9zHHZ3@cluster0.i55sczy.mongodb.net/') // conecta con la base de datos
